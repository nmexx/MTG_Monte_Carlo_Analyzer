...
const MTGMonteCarloAnalyzer = () => {
  ...
  const [mulliganStrategy, setMulliganStrategy] = useState(
    () => getSaved().mulliganStrategy ?? 'balanced'
  );
  const [customMulliganRules, setCustomMulliganRules] = useState(
    () =>
      getSaved().customMulliganRules ?? {
        mulligan0Lands: true,
        mulligan7Lands: true,
  ...
  const [selectedTurnForSequences, setSelectedTurnForSequences] = useState(
    () => getSaved().selectedTurnForSequences ?? 3
  );
              ...
              <div className="panel-grid">
                <div className="panel">
                  ...
                  {(() => {
                    ...
                    const avgCmc =
                      totalNonLandQty > 0 ? (totalCmcSum / totalNonLandQty).toFixed(2) : '—';
                    const rampCount =
                    ...
                    return (
                      <>
                        ...
                        <p>
                          ...
                          <span
                            style={{ color: 'var(--text-secondary, #94a3b8)', fontSize: '0.85em' }}
                          >
                            ({rampPct}% of deck)
                          </span>
                        </p>
                  ...
                  {(() => {
                    ...
                    const pipData = Object.entries(pipCounts)
                      ...
                      .map(([k, v]) => ({
                        color: k,
                        label: colorConfig[k].label,
                        pips: v,
                        fill: colorConfig[k].fill,
                      }));
          ...
          <div className="deck-columns">
            ...
            <div className="panel">
              ...
              <textarea
                ...
                style={{ height: 180 }}
              />
              <button onClick={handleParseDeckB} className="btn-primary">
                Parse Deck
              </button>
            </div>
          </div>
